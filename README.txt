...
> //LOW PRIORITY\\ > When the program crashes, it displays error message saying that there is a dead kernal. 
The only way to fix this is by reopening VSC - 16/12/2022

> //HIGH PRIORITY\\ > Crashes due to memory limit when trying to train the model using the ADAM optimizer - 22/01/2023
